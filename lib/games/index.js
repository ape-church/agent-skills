...
import { playDojoDrop, getDojoDropConfig } from './dojodrop.js';
...
const gameHandlers = {
  ...
  dojodrop: playDojoDrop, // Dojo Drop (cascading slot, no bonus buy)
...
export { getDojoDropConfig } from './dojodrop.js';
